...
<section id="home-section" class="hero">
   ...
   @foreach ( $slider as $sliders )
    ...
    <div class="container" id="containerheight">
        <div class="row">
            <div class="col-md-12">
                  ...
                  <div class="container">
                    <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                      ...
                      <div class=" ftco-animate text-center">
                        <h1 class="mb-2">{{$sliders->slider_description1}}</h1>
                        <h2 class="subheading mb-4">{{$sliders->slider_description2}}</h2>
...
<section class="ftco-section">
  <div class="container">
    ...
    <div class="col-md-12 heading-section text-center ftco-animate">
      ...
      <h2 class="mb-4">LES PRODUITS DISPONIBLES</h2>
         ...
         <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="product">
                ...
                <div class="text py-3 pb-4 px-3 text-center">
                    ...
                    <div class="d-flex">
                        <div class="pricing">
                            <p class="price"><span class="mr-2 price-dc">$120.00</span><span class="price-sale">{{$produits->product_price}}</span></p>
                        </div>
                    </div>
