      ...
      <section class="ftco-section ftco-cart">
                      ...
                      <div class="cart-list">
                          <table class="table">
                             ...
                             <tbody>
                                ...
                                <tr class="text-center">
                                <td class="product-remove"><a href="/retirerproduitdupanier/{{$product['product_id']}}"><span class="ion-ios-close"></span></a></td>
              ...
              <div class="row justify-content-end">
                  ...
                  <div class="col-lg-12 mt-5 cart-wrap ftco-animate">
                      ...
                      <p><a href="{{URL::to('/paiement')}}" class="btn btn-primary py-3 px-4">Paiement</a></p>
                  </div>
              </div>
              </div>
          </section>
