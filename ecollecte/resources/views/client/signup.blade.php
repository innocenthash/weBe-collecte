        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h6 class="font-weight-light">S'inscrire</h6>
              <form class="pt-3" action="" method="post">
                ...
                <fieldset>
                    ...
                    <div class="mt-3">
                        <a href="{{URL::to('/login')}}"> Avez-vous un compte ? connectez-vous</a>
                    </div>
                </fieldset>
            </form>
            </div>
...
@endforeach
@endif
				<form class="login100-form validate-form" action="{{url('/creation_compte_client')}}" method="POST">
                    {{ csrf_field() }}
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="#">
                            <a href="{{URL::to('/loginclient')}}"> Avez-vous un compte ? Se connecter</a>
						</a>
					</div>
				</form>
			</div>
